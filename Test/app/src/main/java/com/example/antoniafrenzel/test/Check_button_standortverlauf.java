...
public class Check_button_standortverlauf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Informationstext.setText("Google speichert wann du wo du dich aufgehalten hast. Außerdem kannst du unter der Google Zeitachse deine letzten Reisen, deine Wohnanschrift sowie den Standort deiner Arbeit finden.\n" +
                "Sollten dir das zu viele Informationen über dich auf einem Schlag sein, hast du die Möglichkeit, den Standortverlauf zu pausieren oder ganz zu deaktivieren ;-)\n\n" +
